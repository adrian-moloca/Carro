      ...
      <Box display= 'flex' flexDirection='column' justifyContent ='center' alignItems='center'>
        <Grid container spacing={3} justifyContent='center'>
            ...
            <Grid container item xs={10} xl={8} justifyContent='center'>  
                <PrimaryButton onClick={() => {fetchLogin(email.toLowerCase(), password); localStorage.setItem('isLoggedIn', true)}} className="ButtonTextSize" size = 'large' variant='contained' fullWidth endIcon={<ExitToAppIcon />}>
                {t("Login")}
                </PrimaryButton>
            </Grid>
        </Grid>
