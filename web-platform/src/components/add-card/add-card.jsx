    ...
    return (
        <Fragment>
            ...
            <Grid container item xs={5} justifyContent='center'>
                <CarroTextField value={props.cardNumber} onChange={props.cardNumberSet} variant ='outlined' label='Numar card' fullWidth/>
            </Grid>
            <Grid container item xs={5} justifyContent='center'>
                <CarroDatePicker dateValue={props.expDate} handleDateSelect={props.expDateSet} views={["month","year"]} format="MM/yy" openTo='month' label='Data expirare'/>  
            </Grid>
            <Grid container item xs={5} justifyContent='center'>
                <CarroTextField value ={props.completeName} onChange={props.completeNameSet} variant ='outlined' label='Nume complet' fullWidth/>
            </Grid>
            <Grid container item xs={5} justifyContent='center'>
