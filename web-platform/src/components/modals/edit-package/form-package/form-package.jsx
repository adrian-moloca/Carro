        ...
        <Box display='flex' justifyContent='center' mt='5%' mb='5%' fontSize='13px'>
            <Grid container spacing={1} >
                <Grid container item xs={12} md ={6} xl={6} justifyContent="center">
                            <CarroAutocomplete size='small' value={props.departureCountry} options={getCountries()}  label={t('SearchRideDepartureCountry')} onChange={(e)=>props.setDepartureCountry(e.target.textContent)}/>
                </Grid>
                <Grid container item xs={12}  md ={6} xl={6} justifyContent="center">
                            <CarroAutocomplete size='small' value={props.departureCity} options={getCities(props.departureCountry)} label={t('SearchRideDepartureCity')} onChange={(e)=>props.setDepartureCity(e.target.textContent)}/>
                </Grid>
                <Grid container item xs={12}  md ={6} xl={6} justifyContent='center'>
                            <CarroTextField size='small' error={addressValidator(props.pickUpAddress)} helperText={addressValidator(props.pickUpAddress) ? t('ValidAddress') : ''}
                ...
                <Grid container item xs={12} md ={6} xl={6} justifyContent="center">
                            <CarroTextField size='small' variant ='outlined' label={t("Sizing")} fullWidth select value={props.packageSize} onChange={(e)=>props.setPackageSize(e.target.value)}>
                ...
                <Grid container item xs={12}  md ={6} xl={6} justifyContent="center">
                            <CarroTextField size='small' type='number' error={numberValidator(props.weight)} helperText={numberValidator(props.weight) ? t('OnlyNumbers') : ''}
                                            value={props.weight}
                ...
                <Grid container item xs={6} justifyContent="center">
                                <CarroTextField size='small' variant="outlined" error={String(props.smallDescription).length <= 3 && props.smallDescription!=''}  
                ...
                <Grid container item xs={6} justifyContent="center">
                                <CarroTextField size='small' variant="outlined" type='number' value={props.price} onChange={(e)=>props.setPrice(e.target.value)}
                ...
                <Grid container item xs={12} justifyContent="center">
                                            <CarroTextField size='small' error={String(props.description).length < 25 && props.description!=''} 
